...
dataColumn2 = pd.read_csv('sonar.csv',usecols=[1])
dataColumn3 = pd.read_csv('sonar.csv',usecols=[2])
...
dataColumn21 = pd.read_csv('sonar.csv',usecols=[20])

plot.scatter(dataColumn2, dataColumn21)
